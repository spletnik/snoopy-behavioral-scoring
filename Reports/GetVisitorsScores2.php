 ...
 */
class GetVisitorsScores2 extends Base {
	protected function init() {
		...
		$this->metrics = array('label', 'email', 'score');
	...
	public function configureView(ViewDataTable $view) {
		$view->config->addTranslations(array('label' => 'visitor'));
		...
		$view->config->show_visualization_only = false;
		$view->config->datatable_css_class = "snoopy-behavioral-scoring";
	...
	/*public function render() {
		$view = new View('@SnoopyBehavioralScoring/getVisitorsScores2');
